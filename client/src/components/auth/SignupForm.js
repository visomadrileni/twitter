...
import './SignupForm.css';
 ...
 class SignupForm extends Component{
     ...
     onSubmit = (e) => {
        ...
        const month = option.innerText;

        post('/users/register',{name,phone,month});
     }
        ...
        return (
                 <div className="signupModal">
                   ...
                   <form onSubmit={this.onSubmit}>
                      ...
                      <h3>Date of birth</h3>
                      <h6>This will not be shown publicly.Confirm your own age,even if this account is for a business,a pet,or something else.</h6>
                      <span className="formbox">
                         <select title="month" name="monthofbirth" className="selectMonth" defaultValue={'DEFAULT'}>
                          ...
                          <select title="Day" name="dayofbirth" className="selectDay" defaultValue={'DEFAULT'}>
                      ...
                      <select title="Year" name="yearofbirth" className="selectYear" defaultValue={'DEFAULT'}>
                          <option value="0" defaultValue>Year</option>
                    ...
                    <input type="submit" value="Next" className="header" />
                  </form>
              </div>
           );
     }
